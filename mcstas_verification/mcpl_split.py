...
def split_mcpl_file(mcpl_file, requested_sizes, filename, input_particles):
    original_data = load_mcpl_file("../ODIN.mcpl.gz", n_particles=1271093).numpy()
...
if __name__ == "__main__":
    ...
    split_mcpl_file("../ODIN.mcpl.gz", requested_sizes, "./mcpl_files/input", 1000000)
    print("\n")
    split_mcpl_file("../cmf_samples.mcpl.gz", requested_sizes, "./mcpl_files/cfm", 1000000)
